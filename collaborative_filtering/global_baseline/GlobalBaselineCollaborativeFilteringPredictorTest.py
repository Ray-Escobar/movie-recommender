...
class MyTestCase(unittest.TestCase):
    def testNaiveCollaborativeFilteringPredictor(self):
        ...
        predictor = GlobalBaselineCollaborativeFilteringPredictor(data_matrix=rating_matrix, k_neighbors=2, row_similarity_matrix=RowPearsonSimilarityMatrix(data_matrix=rating_matrix))
